        ...
        <div id="pageBody">
            ...
            <div class="container max-w-xl mx-auto text-left flex items-center flex-wrap">
                <div class="col-lg-8">
                    ...
                    <h2>Hello Dear Customers!</h2>
                    <p class="text-md md:text-lg text-grey-dark leading-normal">
                        You can view a list of all products!
                    </p>
                    <p><a href="<?php echo $view['urlbaseaddr'] ?>products/index"
                          class="mt-6 inline-block bg-white text-black no-underline px-4 py-3 shadow-lg">View
                            products</a></p>
                </div>
                <div class="col-lg-4">
                    <p><br/><img src="<?php echo $view['urlbaseaddr'] ?>img/lightmvc_logo.png" class="shadow-lg"/><br/>
                    </p>
                </div>
            </div>
            <p><br/><br/><br/></p>
    ...
    <div class="container">
        <div class="row">
            <div class="text-center">
                <p><br/></p>
                <h2 class="leading-normal mb-6 text-grey-darkest"><b>Easily create PHP applications by using any PHP
                        library within this very modular, event-driven and Swoole-enabled framework!</b></h2>
...
<div class="w-full px-6 py-12 bg-white">
    <div class="max-w-xl mx-auto flex flex-wrap">
        ...
        <div class="w-full md:w-1/2 p-2 md:px-6">
            ...
            <p class="mb-5">Built upon proven technologies like Zend Diactoros, Zend Stratigility, and Zend
                EventManager!</p>
            <p class="mb-8">Many great technologies, like Pimple, FastRoute, Plates, and Whoops come together to become
                the LightMVC Framework!</p>
            <p class="mb-8">And, let's not forget these great-looking templates created with Bootstrap and Tailwind
                CSS!</p>
            <a href="<?php echo $view['urlbaseaddr'] ?>products/index"
               class="inline-block bg-black text-white text-3xl px-4 py-3 no-underline">Browse our products</a>
        </div>
