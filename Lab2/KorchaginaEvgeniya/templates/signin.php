...
<div class="container">
    <form class="form-signin" action="index.php" method="post" data-toggle="validator" role="form">
    ...
    <form class="form-signin" action="index.php" method="post" role="form">
        <button class="btn btn-lg btn-primary btn-block" name="signup" value="1">Sign Up</button>
    </form>
</div> <!-- /container -->
